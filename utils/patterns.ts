export const REJECT_NON_ESSENTIAL_PATTERNS: RegExp[] = [
  ...
  /^reject analytics cookies$/i,
  /^decline analytics cookies$/i,
  /^reject analytics$/i,
  /^decline analytics$/i,
...
export const REJECT_PARTIAL_PATTERNS: RegExp[] = [
  ...
  /\breject analytics cookies\b/i,
  /\bdecline analytics cookies\b/i,
  /\breject analytics\b/i,
  /\bdecline analytics\b/i,
];
